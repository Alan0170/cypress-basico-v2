...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('campo telefone continua vazio quando preenchido com valor nao-númerico', function() {
        cy.get('#phone')
        .type('abcdefghij')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        cy.get('#firstName').type('Alan').should('have.value', 'Alan')
        .clear().should('have.value', '')

        cy.get('#lastName').type('Michel').should('have.value', 'Michel')
        .clear().should('have.value', '')

        cy.get('#email').type('alan@exemplo.com').should('have.value', 'alan@exemplo.com')
        .clear().should('have.value', '')
    })
